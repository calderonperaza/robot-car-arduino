...
//Hace la medicion de distancia devuelve cms de distancia hasta 350cm máximo
...
***********************************************************
*/
//inicializando las variables estáticas de la clase
...
Carro::Carro(){
	...
	//Para el registro de las interrupciones
    //RISING indica la interrupcion cuando el pin cambie de 0 a 1
...
//MÉTODOS QUE SE EJECUTAN CON LA INTERRUPCIÓN
//Son metodos estáticos (static va en el .H)
